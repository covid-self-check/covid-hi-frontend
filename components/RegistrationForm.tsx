...
export default function RegistrationForm() {
    ...
    const [nationalIdOrPassportFieldMaxLength, setNationalIdOrPassportFieldMaxLength] = useState(NATIONAL_ID_MAX_LENGTH);
    ...
    function handlePassportInput(passportId: string) {
        ...
        if (nationalIdOrPassportFieldStatus === "passport_new") {
            ...
            return passportId[0].toUpperCase() + passportId[1].toUpperCase() + replaceWithNumbers(passportId.slice(2));
        }
    }
                    ...
                    <Container>
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, value }, fieldState: { error } }) => (
                                <TextField label="ชื่อ" className={styles.text_field} value={value} fullWidth onChange={onChange} error={!!error} helperText={error ? error.message : null} />
                            )}
                        ...
                        <Controller
                            ...
                            defaultValue=""
                            render={({ field: { onChange, value }, fieldState: { error } }) => (
                                <TextField label="นามสกุล" className={styles.text_field} value={value} fullWidth onChange={onChange} error={!!error} helperText={error ? error.message : null} />
                            )}
                        ...
                        <Controller
                            ...
                            control={control}
                            defaultValue=""
                            render={({ field: { onChange, value } }) => <TextField label="โรคประจำตัว" className={styles.text_field} value={value} fullWidth onChange={onChange} />}
                        />

                        <FormLabel className={styles.form_label} component="legend">
                            ที่อยู่และข้อมูลสำหรับการติดต่อ
                        </FormLabel>
                        <Controller
                            name="address"
                            control={control}
                            ...
                            render={({ field: { onChange, value }, fieldState: { error } }) => (
                                <>
                                    <Autocomplete
                                        ...
                                        value={value}
                                        fullWidth
                                        renderInput={(params) => <TextField {...params} label="จังหวัด" variant="outlined" error={!!error} helperText={error ? error.message : null} />}
                                    />
                                </>
                            )}
                        ...
                        <Controller
                            ...
                            control={control}
                            defaultValue=""
                            render={({ field: { onChange, value } }) => <TextField label="ไอดีไลน์" className={styles.text_field} value={value} fullWidth onChange={onChange} />}
                        />
                            ...
                            render={({ field: { onChange, value } }) => (
                                <FormControl className={styles.text_field}>
                                    ...
                                    <FormGroup>
                                        ...
                                        <FormControlLabel control={<Checkbox name="digitalLiteracy" />} label="สามารถกรอกข้อมูลเองได้" />
                                    </FormGroup>
                                </FormControl>
                            )}
                        />
                        ...
                        <Button className={styles.button} form="registrationForm" type="submit" variant="contained" color="primary" fullWidth>
                            ยืนยัน
                        </Button>
                    </Container>
                </form>
